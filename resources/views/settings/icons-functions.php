        ...
        <tr>
            ...
            <td style="vertical-align: middle;">
                <input style="min-width: 100%;" type="text" id="<?php echo esc_attr( $icon_input_name ); ?>" name="<?php echo esc_attr( $icon_input_name ); ?>"
                       ...
                       value="<?php if ( filter_var( $existing_icon, FILTER_VALIDATE_URL ) || strpos( $existing_icon, '/wp-content/' ) === 0 ) : echo esc_url( isset( $existing_icon ) ? $existing_icon : '' ); elseif ( preg_match( '/^mdi\smdi-/', $existing_icon ) ) : echo esc_attr( $existing_icon ); endif; ?>"
