                  ...
                  <table class="widefat striped">
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td><input type="text" id="dt_home_file_upload" name="dt_home_custom_ministry_logo" value="<?php echo esc_url( $dt_home_file_upload ); ?>" pattern=".*\S+.*" title="<?php esc_attr_e( 'The name cannot be empty or just whitespace.', 'dt-home' ); ?>"></td>
                              <td></td>
